 ...
 * @author MGT
 */
public class ISNULL<Y extends Comparable<Y>> extends Predicat implements Serializable{
    ...
    public Predicate generateJPAPredicat(CriteriaBuilder criteriaBuilder, Root<?> root) {
        return criteriaBuilder.isNull(DAOUtilis.<Y>buildPropertyPath(root, propertyName));
    }
