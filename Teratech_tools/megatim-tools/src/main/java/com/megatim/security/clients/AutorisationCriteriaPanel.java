...
/**
 * Panel de recherche AutorisationCriteriaPanel

 * @since Sun Sep 18 21:53:38 CEST 2016
 * 
 */
public class AutorisationCriteriaPanel
    extends JPanel
{
    ...
    @Search(field = "id", type = java.lang.Long.class)
    private JFormattedTextField id;
    private JLabel lbid;
    private JLabel lbmid;
    @Search(field = "nomAutorisation", type = java.lang.String.class)
    ...
    @Search(field = "statut", type = java.lang.String.class)
    private JTextField statut;
    private JLabel lbstatut;
    private JLabel lbmstatut;

    public AutorisationCriteriaPanel() {
        initComponents() ; 
    }
