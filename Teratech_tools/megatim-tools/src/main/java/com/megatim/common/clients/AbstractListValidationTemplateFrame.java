 ...
 * @param <PK>
 */
public abstract class AbstractListValidationTemplateFrame<T extends Object, U extends Object, V extends Object, PK extends Serializable>
        extends javax.swing.JInternalFrame implements MouseListener, KeyListener {

    /**
     * Creates new form AbstractListTemplateFrame
     */
    public AbstractListValidationTemplateFrame() {
    ...
    private void initComponents() {
        ...
        btrejeter = new javax.swing.JButton();
        ...
        btrejeter.setText("Rejéter");
        btrejeter.setIcon(getUpdateIcon());
        btrejeter.setText(getUpdateTitle());
        btrejeter.setToolTipText(getUpdateTooltip());
        btrejeter.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btrejeterActionPerformed(evt);
            }
        });
        ...
        actionsPanelLayout.setHorizontalGroup(
            ...
            .addComponent(btrejeter, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addComponent(btprint, javax.swing.GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)
            .addComponent(btcancel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addComponent(btconsulter, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        actionsPanelLayout.setVerticalGroup(
            ...
            .addGroup(actionsPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btrejeter, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(5, 5, 5)
    ...
    private void btrejeterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btrejeterActionPerformed
        try {
            // TODO add your handling code here:
            rejeter();
        } catch (Exception ex) {
           Messages.Messages(getApplicationFrame(), true, NotificationType.ERROR, "Erreur lors du traitement\nVeuillez consulter les détails", ex.getMessage(),"");
            Logger.getLogger(AbstractListValidationTemplateFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_btrejeterActionPerformed
    ...
    private void btvaliderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btvaliderActionPerformed
        try {
           ...
           Messages.Messages(getApplicationFrame(), true, NotificationType.ERROR, "Un erreur est survenu lors du traitement de votre requête", ex.getMessage(),"");
            Logger.getLogger(AbstractListValidationTemplateFrame.class.getName()).log(Level.SEVERE, null, ex);
            ex.printStackTrace();
        }
    ...
    protected javax.swing.JButton btrejeter;
    ...
    public void search() {
        ...
        try {
            ...
            ex.printStackTrace();
            Alerte.getAlerteDialog(MessagesBundle.getMessage("error.title"), MessagesBundle.getMessage("error.shortmessage"), ex.getMessage());
        }
    }
     ...
     * @return @throws Exception
     */
    protected abstract GenericManager getRejetManager() throws Exception;
    ...
    public void valider() throws Exception {
        ...
        JDialog nouveauFrame = getValideEditDialog(validateWapper(getSelectedObjects().get(0)), getValideManager(), TypeOperation.NEW, getApplicationFrame());
    ...
    public void rejeter() throws Exception {
        ...
        JDialog nouveauFrame = getRejetEditDialog(rejectWapper(getSelectedObjects().get(0)), getRejetManager(), TypeOperation.NEW, getApplicationFrame());
        nouveauFrame.setLocationRelativeTo(null);
        nouveauFrame.setVisible(true);
...
//        System.out.println("le nom du fichier jasper a afficher :" + reportFile);
     ...
     * @throws Exception
     */
    protected abstract JDialog getRejetEditDialog(V object, GenericManager manager, TypeOperation typeOperation, JFrame window) throws Exception;
     ...
     * @return
     */
    protected abstract V rejectWapper(T object);
