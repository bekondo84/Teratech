...
//            ex.printStackTrace();
    ...
    /**
     * Applique les r_gles de sécurité a la fenetre courante
     */
	...
	private void initComponents() {
		...
		title = BorderFactory.createTitledBorder(null,
				MessagesBundle.getMessage("Critéres de  Recherche..."),
    ...
    private void btviewActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btviewActionPerformed
        try {
            ...
            Messages.Messages(getApplicationFrame(), true,
                    ...
                    "Aucun élément n'est sélectionné !!!", ex.getMessage(),
                    "");
             Logger.getLogger(AbstractListTemplateFrame.class.getName()).log(Level.SEVERE,
             null, ex);
        }
    ...
    /**
     * titre du dialog de l'état
     *
     * @author <a href="mailto:ntchuenna@yahoo.fr">nadège Tchuente</a> 12 nov.
     * 2016
     * @return
     */
    ...
    public void supprimer() throws Exception {
        ...
        boolean choice = Messages.Messages(getApplicationFrame(), true,
                ...
                "Voulez-voous supprimer cet élément ?", "");
