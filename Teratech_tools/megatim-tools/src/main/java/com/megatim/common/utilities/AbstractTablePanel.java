 ...
 * @author DEV_4
 */
public abstract class AbstractTablePanel<T extends Object> extends javax.swing.JPanel {
    ...
    private void viewComponents() {
        ...
        footerTable.setFont(times);
        footerScrollPane.setVisible(false);
    ...
    private void initComponents() {
        ...
        footerTable = new javax.swing.JTable();
        ...
        footerTable.setBackground(new java.awt.Color(204, 204, 204));
        footerTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null}
            },
            new String [] {
        ...
        footerScrollPane.setViewportView(footerTable);
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(footerScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(optionsToolPane, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private void btaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btaddActionPerformed
        try {
            ...
            Logger.getLogger(AbstractTablePanel.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void bteditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bteditActionPerformed
        try {
            ...
            Logger.getLogger(AbstractTablePanel.class.getName()).log(Level.SEVERE, null, ex);
            Messages.Messages(getApplicationFrame(), true, NotificationType.ERROR, "Erreur pendant  le traitement\nVeuillez consulter les détails", ex.getMessage(), "");
        }
    ...
    /**
     * Fonction de traitement des evenements souris
     *
     * @param evt
     */
    public void onMouseEvent(java.awt.event.MouseEvent evt) {
        ;
    }
     ...
     * @param evt
     */
    public void onKeyEvent(java.awt.event.KeyEvent evt) {
        ;
    }
    ...
    public void setModel(AbstractTableBaseListModel model) {
        ...
        if (summaryModel != null) {
            summaryModel.setElements(model.getElements());
            footerTable.setModel(summaryModel);
        }
    }
     ...
     * @return
     */
    public AbstractTableSummaryModel getSummaryModel() {
        return summaryModel;
    }
     ...
     * @param summaryModel
     */
    public void setSummaryModel(AbstractTableSummaryModel summaryModel) {
    ...
    protected javax.swing.JScrollPane footerScrollPane;
    protected javax.swing.JTable footerTable;
    private javax.swing.JPanel jPanel3;
    private javax.swing.JScrollPane jScrollPane2;
    private javax.swing.JToolBar optionsToolPane;
    // End of variables declaration//GEN-END:variables
    protected AbstractTableBaseListModel model = null;
    protected AbstractTableSummaryModel summaryModel = null;
     ...
     */
    protected abstract JDialog getEditDialog(T object, GenericManager manager, AbstractTableBaseListModel model, TypeOperation typeOperation, JFrame window) throws Exception;
    ...
    public void nouveau() throws Exception {
        ...
        nouveauFrame.addWindowListener(new WindowAdapter() {

            @Override
            public void windowClosed(WindowEvent e) {
                if (summaryModel != null && model != null) {
                    summaryModel.setElements(model.getElements());
                    footerTable.setModel(summaryModel);
                }
    ...
    public void supprimer() throws Exception {
        ...
        if (getSelectedObjects() == null) {
            Messages.Messages(PrincipalFrame.principalScreen, true, NotificationType.INFOS, "Aucune ligne n'est sélectionnée !", "", "");

            return;
        }

        boolean choice = Messages.Messages(PrincipalFrame.principalScreen, true, NotificationType.WARNING, "Voulez vous vraiment effectuer cette opération ?", "");
        ...
        if (choice) {
            ...
            for (T object : objects) {
                model.deleteElement((Comparable) object);
                if (summaryModel != null) {
                    summaryModel.setElements(model.getElements());
                    footerTable.setModel(summaryModel);
                }
    ...
    public void modifier() throws Exception {
        ...
        JDialog nouveauFrame = getEditDialog(getSelectedObjects().get(0), getManager(), model, TypeOperation.UPDATE, getApplicationFrame());
        nouveauFrame.setLocationRelativeTo(getApplicationFrame());
        ((AbstractEditTemplateDialog) nouveauFrame).setSelectedRow(selectedRow);
        nouveauFrame.setVisible(true);
        nouveauFrame.addWindowListener(new WindowAdapter() {
    ...
    protected void enabledSubTotalTable(Boolean value) {
        footerScrollPane.setVisible(value);
        footerTable.setVisible(value);
        summary = value;
    }
}
