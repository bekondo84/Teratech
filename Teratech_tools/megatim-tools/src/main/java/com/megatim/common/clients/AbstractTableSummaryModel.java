 ...
 */
public abstract class AbstractTableSummaryModel<T extends Comparable<? super T>> extends AbstractTableModel implements TableModel {
    ...
    /**
     * M�thode d'obtention de l'Etat de mofiabilit� d'une cellule de la
     * Table
     *
    ...
    /**
     * M�thode d'obtention de la valeur de la propri�t� bind�e sur la
     * colonne en param�tre de la Table
     *
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        return getColoumnValue(null, columnIndex);
    }
     ...
     */
    protected Object getValue(T object, String fieldName) throws IllegalArgumentException, IllegalAccessException {

        if (object == null || fieldName == null || fieldName.trim().isEmpty()) {
            return null;
        }
        Field[] fields = ValidateAndFillBeans.getObjectDeclaredFields(object.getClass());
     ...
     * @return
     */
    private boolean isNumericType(Class<?> classe) {

        if (classe.equals(Integer.class) || classe.equals(int.class) || classe.equals(short.class)
                ...
                || classe.equals(Float.class) || classe.equals(BigDecimal.class)) {
            return true;
        } else {
            return false;
        }
     ...
     * @return
     */
    private boolean isNumericPrecision(Class<?> classe) {

        if (classe.equals(Integer.class) || classe.equals(int.class) || classe.equals(short.class)
                || classe.equals(Short.class) || classe.equals(Long.class) || classe.equals(long.class)) {
            return true;
        } else {
            return false;
        }
    ...
    protected Double sum(String fieldName) throws IllegalArgumentException, IllegalAccessException {
        ...
        for (T elt : elements) {
            ...
            Object value = getValue(elt, fieldName);
