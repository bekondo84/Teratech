...
public class Infos extends javax.swing.JDialog {
     ...
     */
    public Infos(java.awt.Frame parent, boolean modal, NotificationType typenotification, String message) {
        super(parent, modal);
        initComponents();
        buildviews();
    ...
    private void initComponents() {
        ...
        message.setForeground(new java.awt.Color(125, 204, 252));
    ...
    private void buildviews() {
        message.setIcon(new ImageIcon(ClassLoader.getSystemResource("com/megatim/tools/images/infos.png")));
        this.setIconImage((new ImageIcon(ClassLoader.getSystemResource("com/megatim/tools/images/infos.png"))).getImage());
    ...
    public static void getInfosDialog(Frame parent, boolean modal, NotificationType typenotification, String message) {
        Infos succes = new Infos(parent, true, typenotification, message);
