 ...
 * @since  20/O4/2016
 */
public class SystemEncryptioMetaData {
	 ...
	 */
    private static SystemEncryptioMetaData _instance = null;
     ...
     */
    private SystemEncryptioMetaData() {
    ...
    public synchronized static SystemEncryptioMetaData getInstance(){
        
        //Si instance est null 
        if(passwordKey==null){
            try {
               //  System.out.println("DESEncrypter.getInstance() :::::::::::::: "+DESEncrypter.class);
                 InputStream url = SystemEncryptioMetaData.class.getResourceAsStream("/com/megatim/keys/keystore.data");
         ...
         _instance = new SystemEncryptioMetaData();
